...
Query_block *build_show_keys_query(const POS &pos, THD *thd,
  ...
  */
  ...
  Select_lex_builder top_query(&pos, thd);
    ...
    Item *index_type_item = new (thd->mem_root)
      Item_field(pos, NullS, NullS, alias_type.str);
    ...
    Item *one_item =
      new (thd->mem_root) Item_string(STRING_WITH_LEN("1"), system_charset_info);
    ...
    Item *vector_item =
      new (thd->mem_root) Item_string(STRING_WITH_LEN("VECTOR"), system_charset_info);
    if (vector_item == nullptr) return nullptr;

    Item *index_type_else_item = new (thd->mem_root)
      Item_field(pos, NullS, NullS, alias_type.str);
    ...
    Item *index_type_default_item = new (thd->mem_root)
      Item_field(pos, NullS, NullS, alias_type.str);
